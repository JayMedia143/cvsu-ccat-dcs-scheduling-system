...
class GeneticScheduler:
    ...
    def __init__(self, courses, sections, faculty, rooms, pre_assignments,
        ...
        for code in ('ROOM_AVAILABILITY', 'ROOM_SUITABILITY', 'ROOM_CAPACITY_PROPORTIONAL',
                     ...
                     'STRICT_ALLOC_ASYNC', 'STRICT_ALLOC_LEC', 'STRICT_ALLOC_LAB',
    ...
    def create_genome(self, skip_exhaustive=False):
        ...
        # Prioritize: Low Workload First -> Labs First -> Section Student Capacity -> Fewest Eligible Rooms -> Longest Duration
        def _mrv_key(a):
            ...
            # Section students (Largest first): -sec_stu
            # Room eligibility (Fewest First): eligible
            # Duration (Longest First): -slots
            return (workload, type_pri, -sec_stu, eligible, -a['slots'])
    ...
    def _reclaim_online_genes(self, genes, occ_room, occ_fac, occ_sec):
        ...
        Directed Repair for the Lec→Lab fallback.
        """
    ...
    def _try_compact_place(self, gene, occ_room, occ_fac, occ_sec,
        ...
        if gene.gene_type == 'Lab':
            ...
            room_phases = [self._seq_lec_rooms]
    ...
    def _classify_conflicts(self, chromosome):
        ...
        for i in chromosome.conflicting_indices:
            ...
            # Duration mismatch (exempt split hours)
            if (g.course_id, g.section_id, g.gene_type) not in self.split_map:
