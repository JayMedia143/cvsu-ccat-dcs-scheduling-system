# seeder5.py — Benchmark Level 5: MEDIUM (16 sections, ~168 genes)
# Run: python seeder5.py
import sys, os
...
CURRICULUM = {
    ...
    'BSCoS 201-A': _cs_yr2, 'BSCoS 201-B': _cs_yr2,
    'BSCoS 301-A': _cs_yr3, 'BSCoS 301-B': _cs_yr3,
    'BSCoS 401-A': _cs_yr4, 'BSCoS 401-B': _cs_yr4,
    'BSIT 101-A':  _it_yr1, 'BSIT 101-B':  _it_yr1,
    'BSIT 201-A':  _it_yr2, 'BSIT 201-B':  _it_yr2,
...
SECTIONS = [
    ...
    {'name': 'BSCoS 301-A', 'year': 3, 'students': 35}, {'name': 'BSCoS 301-B', 'year': 3, 'students': 35},
    {'name': 'BSCoS 401-A', 'year': 4, 'students': 30}, {'name': 'BSCoS 401-B', 'year': 4, 'students': 30},
    ...
    {'name': 'BSIT 301-A',  'year': 3, 'students': 35}, {'name': 'BSIT 301-B',  'year': 3, 'students': 35},
    {'name': 'BSIT 401-A',  'year': 4, 'students': 30}, {'name': 'BSIT 401-B',  'year': 4, 'students': 30},
]
