# seeder7.py — Benchmark Level 7: 24 sections, ~252 genes
# Run: python seeder7.py
import sys, os
...
SEEDER_LEVEL  = 7
GENE_ESTIMATE = 252
DESCRIPTION   = "24 sections (BSCoS + BSIT Yr1-4, A/B/C), 12 rooms, 26 faculty"
...
ROOMS = [
    ...
    {'name': 'C1',             'building': 'ICT Building C', 'capabilities': 'Lecture',              'status': 'Available',                 'capacity': 40,  'func_comp': 0},
    {'name': 'C2',             'building': 'ICT Building C', 'capabilities': 'Lecture',              'status': 'Available',                 'capacity': 40,  'func_comp': 0},
]

# ---------------------------------------------------------------------------
# FACULTY  (12 TBA + 14 real = 26)
# ---------------------------------------------------------------------------
FACULTY = [
...
# ---------------------------------------------------------------------------
# SECTIONS  (A/B/C per year per program = 24 total)
# ---------------------------------------------------------------------------
SECTIONS = [
    # BSCoS Year 1
...
CURRICULUM = {
    # BSCoS Year 1
    'BSCoS 101-A': _BSCOS_YR1, 'BSCoS 101-B': _BSCOS_YR1, 'BSCoS 101-C': _BSCOS_YR1,
    # BSCoS Year 2
    'BSCoS 201-A': _BSCOS_YR2, 'BSCoS 201-B': _BSCOS_YR2, 'BSCoS 201-C': _BSCOS_YR2,
    # BSCoS Year 3
    'BSCoS 301-A': _BSCOS_YR3, 'BSCoS 301-B': _BSCOS_YR3, 'BSCoS 301-C': _BSCOS_YR3,
    # BSCoS Year 4
    'BSCoS 401-A': _BSCOS_YR4, 'BSCoS 401-B': _BSCOS_YR4, 'BSCoS 401-C': _BSCOS_YR4,
    # BSIT Year 1
    'BSIT 101-A': _BSIT_YR1,  'BSIT 101-B': _BSIT_YR1,  'BSIT 101-C': _BSIT_YR1,
    # BSIT Year 2
    'BSIT 201-A': _BSIT_YR2,  'BSIT 201-B': _BSIT_YR2,  'BSIT 201-C': _BSIT_YR2,
    # BSIT Year 3
    'BSIT 301-A': _BSIT_YR3,  'BSIT 301-B': _BSIT_YR3,  'BSIT 301-C': _BSIT_YR3,
    # BSIT Year 4
    'BSIT 401-A': _BSIT_YR4,  'BSIT 401-B': _BSIT_YR4,  'BSIT 401-C': _BSIT_YR4,
}
