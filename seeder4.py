# seeder4.py — Benchmark Level 4: SMALL-MEDIUM (12 sections, ~126 genes)
# Run: python seeder4.py
import sys, os
...
SEEDER_LEVEL   = 4
GENE_ESTIMATE  = 126
DESCRIPTION    = "12 sections (BSCoS+BSIT Yr1-2 x3 each), 2-program Year1-2 curriculum"
...
SECTIONS = [
    ...
    {'name': 'BSCoS 101-C', 'year': 1, 'students': 40}, {'name': 'BSCoS 201-A', 'year': 2, 'students': 40},
    {'name': 'BSCoS 201-B', 'year': 2, 'students': 40}, {'name': 'BSCoS 201-C', 'year': 2, 'students': 40},
    {'name': 'BSIT 101-A',  'year': 1, 'students': 40}, {'name': 'BSIT 101-B',  'year': 1, 'students': 40},
    {'name': 'BSIT 101-C',  'year': 1, 'students': 40}, {'name': 'BSIT 201-A',  'year': 2, 'students': 40},
    {'name': 'BSIT 201-B',  'year': 2, 'students': 40}, {'name': 'BSIT 201-C',  'year': 2, 'students': 40},
]
