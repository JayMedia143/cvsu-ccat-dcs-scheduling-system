...
class GeneticSchedulerTC3:
    ...
    def run_algorithm(self, progress_callback=None):
        start_t0 = time.time()
        print("=== RUNNING ALPHA TEST CASE 3: PRE-FEASIBILITY CHECK & HC-24 FILTER ===")
        
        # LEVEL 1 PRE-FEASIBILITY CHECK
        ...
        print(f"🛡️ HC-24 Filter: {len(self._hc24_exempt_sections)} section(s) mathematically exempt from 3hr/day minimum rule.")
        print("Telemetry: Bitmask Caching + Pre-Feasibility Checks active.")
        
        population = [self.create_genome() for _ in range(POPULATION_SIZE)]
        best_schedule = None
        
        for generation in range(1, MAX_GENERATIONS + 1):
            for chrom in population: self.calculate_fitness(chrom)
...
if __name__ == '__main__':
    print("================================================================")
    print("🧪 ALPHA TESTING: TEST CASE 3 (PRE-FEASIBILITY CHECK & HC-24 FILTER)")
    print("================================================================")
    ...
    with app.app_context():
        ...
        scheduler = GeneticSchedulerTC3(courses, sections, faculty, rooms, pre_assignments, {}, start_time=7, end_time=21, allowed_days=active_days)
