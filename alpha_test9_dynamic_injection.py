...
class GeneticSchedulerTC9:
    ...
    def fast_non_dominated_sort(self, population):
        ...
        domination_cnt = [0] * n
        dom = GeneticSchedulerTC9._constrained_dominates
    ...
    def run_algorithm(self, progress_callback=None):
        start_t0 = time.time()
        print("=== RUNNING ALPHA TEST CASE 9: DYNAMIC INJECTION & TELEMETRY ===")
...
if __name__ == '__main__':
    print("================================================================")
    print("🧪 ALPHA TESTING: TEST CASE 9 (DYNAMIC INJECTION & TELEMETRY)")
    print("================================================================")
    ...
    with app.app_context():
        ...
        scheduler = GeneticSchedulerTC9(courses, sections, faculty, rooms, pre_assignments, {}, start_time=7, end_time=21, allowed_days=active_days)
