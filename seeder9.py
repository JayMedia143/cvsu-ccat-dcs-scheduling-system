# seeder9.py — Benchmark Level 9: STRESS TEST (48 sections, ~472 genes)
# Run: python seeder9.py
# This is LARGER than seed_db.py (seeder10) — designed to find GA capacity limits.
import sys, os
...
SEEDER_LEVEL   = 9
GENE_ESTIMATE  = 472
DESCRIPTION    = "48 sections (BSCoS+BSIT+BSAS Yr1-4 x4), 3-program STRESS TEST beyond seed_db.py"
...
ROOMS = [
    ...
    # ICT Building B — Computer Labs (Lecture + Lab)
    ...
    # Arts & Sciences Building — Lecture rooms for BSAS
    {'name': 'C1', 'building': 'Arts Building',  'capabilities': 'Lecture', 'status': 'Available', 'capacity': 45, 'func_comp': 0},
    {'name': 'C2', 'building': 'Arts Building',  'capabilities': 'Lecture', 'status': 'Available', 'capacity': 45, 'func_comp': 0},
    {'name': 'C3', 'building': 'Arts Building',  'capabilities': 'Lecture', 'status': 'Available', 'capacity': 45, 'func_comp': 0},
    {'name': 'C4', 'building': 'Arts Building',  'capabilities': 'Lecture', 'status': 'Available', 'capacity': 45, 'func_comp': 0},
    # Media Lab — for HUMN302 (Media Arts lab component)
    {'name': 'MediaLab', 'building': 'Arts Building', 'capabilities': 'Lecture,Computer Lab', 'status': 'Available', 'capacity': 30, 'func_comp': 20},
    # Special rooms
...
FACULTY = [
    ...
    {'eid': 'DAS-003', 'name': 'Andres Bonifacio',      'dept': 'Arts & Sciences',     'status': 'Part-time', 'max_weekly': 35, 'sex': 'M', 'rank': 'Instructor III',          'attainment': 'Bachelor of Science in Biology',    'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    {'eid': 'DAS-004', 'name': 'Melchora Aquino',       'dept': 'Arts & Sciences',     'status': 'Part-time', 'max_weekly': 35, 'sex': 'F', 'rank': 'Instructor I',            'attainment': 'Bachelor of Arts in English',       'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    {'eid': 'DAS-005', 'name': 'Jose Rizal',            'dept': 'Arts & Sciences',     'status': 'Full-time', 'max_weekly': 17, 'sex': 'M', 'rank': 'Assistant Professor I',   'attainment': 'Master of Arts in Education',       'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DAS-006', 'name': 'Marcelo Del Pilar',     'dept': 'Arts & Sciences',     'status': 'Part-time', 'max_weekly': 35, 'sex': 'M', 'rank': 'Instructor I',            'attainment': 'Bachelor of Arts in Filipino',      'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    {'eid': 'DAS-007', 'name': 'Pilar Hidalgo Lim',    'dept': 'Arts & Sciences',     'status': 'Full-time', 'max_weekly': 17, 'sex': 'F', 'rank': 'Assistant Professor II',  'attainment': 'Master of Arts in Education',       'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DAS-008', 'name': 'Trinidad Tecson',       'dept': 'Arts & Sciences',     'status': 'Part-time', 'max_weekly': 35, 'sex': 'F', 'rank': 'Instructor II',           'attainment': 'Bachelor of Arts in English',       'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    {'eid': 'DAS-009', 'name': 'Josephine Bracken',     'dept': 'Arts & Sciences',     'status': 'Full-time', 'max_weekly': 17, 'sex': 'F', 'rank': 'Instructor I',            'attainment': 'Bachelor of Science in Biology',    'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DAS-010', 'name': 'Gregoria de Jesus',     'dept': 'Arts & Sciences',     'status': 'Part-time', 'max_weekly': 35, 'sex': 'F', 'rank': 'Instructor II',           'attainment': 'Bachelor of Arts in Filipino',      'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    ...
    {'eid': 'DTE-002', 'name': 'Leonor Briones',        'dept': 'Teachers Education',  'status': 'Part-time', 'max_weekly': 35, 'sex': 'F', 'rank': 'Instructor I',            'attainment': 'Bachelor of Secondary Education',   'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    {'eid': 'DTE-003', 'name': 'Sara Duterte',          'dept': 'Teachers Education',  'status': 'Full-time', 'max_weekly': 17, 'sex': 'F', 'rank': 'Assistant Professor II',  'attainment': 'Master of Arts in Education',       'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DTE-004', 'name': 'Armin Luistro',         'dept': 'Teachers Education',  'status': 'Part-time', 'max_weekly': 35, 'sex': 'M', 'rank': 'Instructor II',           'attainment': 'Bachelor of Secondary Education',   'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    {'eid': 'DTE-005', 'name': 'Benigno Aquino Jr',     'dept': 'Teachers Education',  'status': 'Full-time', 'max_weekly': 17, 'sex': 'M', 'rank': 'Assistant Professor I',   'attainment': 'Master of Arts in Teaching',        'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DTE-006', 'name': 'Jose Abad Santos',      'dept': 'Teachers Education',  'status': 'Part-time', 'max_weekly': 35, 'sex': 'M', 'rank': 'Instructor I',            'attainment': 'Bachelor of Secondary Education',   'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
        # Department of Engineering
    {'eid': 'CEN-001', 'name': 'Lapu-Lapu',             'dept': 'Engineering',         'status': 'Full-time', 'max_weekly': 17, 'sex': 'M', 'rank': 'Assistant Professor I',   'attainment': 'Master of Science in Engineering',             'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'CEN-002', 'name': 'Antonio Luna',          'dept': 'Engineering',         'status': 'Part-time', 'max_weekly': 35, 'sex': 'M', 'rank': 'Instructor I',            'attainment': 'Bachelor of Science in Civil Engineering',      'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    {'eid': 'CEN-003', 'name': 'Teodora Alonso',        'dept': 'Engineering',         'status': 'Full-time', 'max_weekly': 17, 'sex': 'F', 'rank': 'Instructor II',           'attainment': 'Bachelor of Science in Civil Engineering',      'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'CEN-004', 'name': 'Baldomero Aguinaldo',   'dept': 'Engineering',         'status': 'Part-time', 'max_weekly': 35, 'sex': 'M', 'rank': 'Instructor I',            'attainment': 'Bachelor of Science in Electrical Engineering', 'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    {'eid': 'CEN-005', 'name': 'Francisco Baltazar',    'dept': 'Engineering',         'status': 'Full-time', 'max_weekly': 17, 'sex': 'M', 'rank': 'Assistant Professor I',   'attainment': 'Master of Science in Engineering',             'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'CEN-006', 'name': 'Emilio Jacinto',        'dept': 'Engineering',         'status': 'Part-time', 'max_weekly': 35, 'sex': 'M', 'rank': 'Instructor II',           'attainment': 'Bachelor of Science in Electrical Engineering', 'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    # Additional DTE for large Arts program
    {'eid': 'DTE-007', 'name': 'Celso Manguerra',       'dept': 'Teachers Education',  'status': 'Full-time', 'max_weekly': 17, 'sex': 'M', 'rank': 'Instructor III',          'attainment': 'Bachelor of Secondary Education',              'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DTE-008', 'name': 'Felicidad Montejo',     'dept': 'Teachers Education',  'status': 'Part-time', 'max_weekly': 35, 'sex': 'F', 'rank': 'Instructor II',           'attainment': 'Bachelor of Secondary Education',              'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    # Additional DAS for large Arts program
    {'eid': 'DAS-011', 'name': 'Gat Andres Luna',       'dept': 'Arts & Sciences',     'status': 'Full-time', 'max_weekly': 17, 'sex': 'M', 'rank': 'Instructor III',          'attainment': 'Bachelor of Science in Physics',               'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DAS-012', 'name': 'Claro Recto',           'dept': 'Arts & Sciences',     'status': 'Part-time', 'max_weekly': 35, 'sex': 'M', 'rank': 'Instructor I',            'attainment': 'Bachelor of Arts in Filipino',                 'days': 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'},
    ...
    {'eid': 'DCS-017', 'name': 'John von Neumann',      'dept': 'Department of Computer Studies', 'status': 'Full-time', 'max_weekly': 21, 'sex': 'M', 'rank': 'Assistant Professor I',   'attainment': 'Master of Science in Computer Science',        'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DCS-018', 'name': 'Donald Knuth',          'dept': 'Department of Computer Studies', 'status': 'Full-time', 'max_weekly': 21, 'sex': 'M', 'rank': 'Assistant Professor I',   'attainment': 'Master of Science in Computer Science',        'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DCS-019', 'name': 'Richard Stallman',      'dept': 'Department of Computer Studies', 'status': 'Full-time', 'max_weekly': 21, 'sex': 'M', 'rank': 'Assistant Professor I',   'attainment': 'Master of Science in Computer Science',        'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
    {'eid': 'DCS-020', 'name': 'Guido van Rossum',      'dept': 'Department of Computer Studies', 'status': 'Full-time', 'max_weekly': 21, 'sex': 'M', 'rank': 'Assistant Professor I',   'attainment': 'Master of Science in Computer Science',        'days': 'Monday,Tuesday,Wednesday,Thursday,Friday'},
]
...
COURSES = [
    ...
    # ── BSCoS (Computer Science) courses ──
    # Year 1
    ...
    # ── BSIT (Information Technology) courses ──
    # Year 1
    ...
    # ── BSAS (Arts and Sciences) courses ──
    # Year 1
    ('HUMN101', 'Art Appreciation',                     1, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('ECON101', 'General Economics',                    1, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('LITT101', 'Philippine Literature',                1, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    # Year 2
    ('HUMN201', 'World Literature',                     2, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('ECON201', 'Microeconomics',                       2, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('LITT201', 'Asian Literature',                     2, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('SOSC201', 'Social Psychology',                    2, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    # Year 3
    ('HUMN301', 'Philosophy of Man',                    3, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('HUMN302', 'Media Arts',                           3, 'BSAS', 'Department of Arts and Sciences', 2, 3, 0, 0, '1st Semester'),
    ('ECON301', 'Macroeconomics',                       3, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('SOSC302', 'Society and Culture',                  3, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    # Year 4
    ('HUMN401', 'Research Methods in Humanities',       4, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('HUMN402', 'Thesis Writing',                       4, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('ECON401', 'Development Economics',                4, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('LITT401', 'Creative Writing',                     4, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
    ('SOSC402', 'Community Extension Service',          4, 'BSAS', 'Department of Arts and Sciences', 3, 0, 0, 0, '1st Semester'),
]
...
_as_yr1  = ['HUMN101', 'ECON101', 'LITT101', 'SOSC101', 'PHED101', 'ENGL101', 'FILI101', 'MATH101']
_as_yr2  = ['HUMN201', 'ECON201', 'LITT201', 'SOSC201', 'PHED201', 'ENGL201', 'FILI201', 'MATH201']
_as_yr3  = ['HUMN301', 'HUMN302', 'ECON301', 'SOSC302', 'SOSC301', 'PHED301', 'ENGL301', 'MATH301']
_as_yr4  = ['HUMN401', 'HUMN402', 'ECON401', 'LITT401', 'SOSC402', 'SOSC401', 'ENGL401', 'MATH401']

CURRICULUM = {
    # BSCoS — 4 sections per year level
    'BSCoS 101-A': _cs_yr1, 'BSCoS 101-B': _cs_yr1, 'BSCoS 101-C': _cs_yr1, 'BSCoS 101-D': _cs_yr1,
    'BSCoS 201-A': _cs_yr2, 'BSCoS 201-B': _cs_yr2, 'BSCoS 201-C': _cs_yr2, 'BSCoS 201-D': _cs_yr2,
    'BSCoS 301-A': _cs_yr3, 'BSCoS 301-B': _cs_yr3, 'BSCoS 301-C': _cs_yr3, 'BSCoS 301-D': _cs_yr3,
    'BSCoS 401-A': _cs_yr4, 'BSCoS 401-B': _cs_yr4, 'BSCoS 401-C': _cs_yr4, 'BSCoS 401-D': _cs_yr4,
    # BSIT — 4 sections per year level
    'BSIT 101-A': _it_yr1, 'BSIT 101-B': _it_yr1, 'BSIT 101-C': _it_yr1, 'BSIT 101-D': _it_yr1,
    'BSIT 201-A': _it_yr2, 'BSIT 201-B': _it_yr2, 'BSIT 201-C': _it_yr2, 'BSIT 201-D': _it_yr2,
    'BSIT 301-A': _it_yr3, 'BSIT 301-B': _it_yr3, 'BSIT 301-C': _it_yr3, 'BSIT 301-D': _it_yr3,
    'BSIT 401-A': _it_yr4, 'BSIT 401-B': _it_yr4, 'BSIT 401-C': _it_yr4, 'BSIT 401-D': _it_yr4,
    # BSAS — 4 sections per year level (Arts & Sciences)
    'BSAS 101-A': _as_yr1, 'BSAS 101-B': _as_yr1, 'BSAS 101-C': _as_yr1, 'BSAS 101-D': _as_yr1,
    'BSAS 201-A': _as_yr2, 'BSAS 201-B': _as_yr2, 'BSAS 201-C': _as_yr2, 'BSAS 201-D': _as_yr2,
    'BSAS 301-A': _as_yr3, 'BSAS 301-B': _as_yr3, 'BSAS 301-C': _as_yr3, 'BSAS 301-D': _as_yr3,
    'BSAS 401-A': _as_yr4, 'BSAS 401-B': _as_yr4, 'BSAS 401-C': _as_yr4, 'BSAS 401-D': _as_yr4,
}

# ── SECTIONS (48 total) ───────────────────────────────────────────────────────
SECTIONS = [
    # BSCoS (16)
    {'name': 'BSCoS 101-A', 'year': 1, 'students': 40}, {'name': 'BSCoS 101-B', 'year': 1, 'students': 40},
    {'name': 'BSCoS 101-C', 'year': 1, 'students': 40}, {'name': 'BSCoS 101-D', 'year': 1, 'students': 40},
    {'name': 'BSCoS 201-A', 'year': 2, 'students': 40}, {'name': 'BSCoS 201-B', 'year': 2, 'students': 40},
    {'name': 'BSCoS 201-C', 'year': 2, 'students': 40}, {'name': 'BSCoS 201-D', 'year': 2, 'students': 40},
    {'name': 'BSCoS 301-A', 'year': 3, 'students': 40}, {'name': 'BSCoS 301-B', 'year': 3, 'students': 40},
    {'name': 'BSCoS 301-C', 'year': 3, 'students': 40}, {'name': 'BSCoS 301-D', 'year': 3, 'students': 40},
    {'name': 'BSCoS 401-A', 'year': 4, 'students': 40}, {'name': 'BSCoS 401-B', 'year': 4, 'students': 40},
    {'name': 'BSCoS 401-C', 'year': 4, 'students': 40}, {'name': 'BSCoS 401-D', 'year': 4, 'students': 40},
    # BSIT (16)
    {'name': 'BSIT 101-A',  'year': 1, 'students': 40}, {'name': 'BSIT 101-B',  'year': 1, 'students': 40},
    {'name': 'BSIT 101-C',  'year': 1, 'students': 40}, {'name': 'BSIT 101-D',  'year': 1, 'students': 40},
    {'name': 'BSIT 201-A',  'year': 2, 'students': 40}, {'name': 'BSIT 201-B',  'year': 2, 'students': 40},
    {'name': 'BSIT 201-C',  'year': 2, 'students': 40}, {'name': 'BSIT 201-D',  'year': 2, 'students': 40},
    {'name': 'BSIT 301-A',  'year': 3, 'students': 40}, {'name': 'BSIT 301-B',  'year': 3, 'students': 40},
    {'name': 'BSIT 301-C',  'year': 3, 'students': 40}, {'name': 'BSIT 301-D',  'year': 3, 'students': 40},
    {'name': 'BSIT 401-A',  'year': 4, 'students': 40}, {'name': 'BSIT 401-B',  'year': 4, 'students': 40},
    {'name': 'BSIT 401-C',  'year': 4, 'students': 40}, {'name': 'BSIT 401-D',  'year': 4, 'students': 40},
    # BSAS — Bachelor of Arts and Sciences (16)
    {'name': 'BSAS 101-A',  'year': 1, 'students': 40}, {'name': 'BSAS 101-B',  'year': 1, 'students': 40},
    {'name': 'BSAS 101-C',  'year': 1, 'students': 40}, {'name': 'BSAS 101-D',  'year': 1, 'students': 40},
    {'name': 'BSAS 201-A',  'year': 2, 'students': 40}, {'name': 'BSAS 201-B',  'year': 2, 'students': 40},
    {'name': 'BSAS 201-C',  'year': 2, 'students': 40}, {'name': 'BSAS 201-D',  'year': 2, 'students': 40},
    {'name': 'BSAS 301-A',  'year': 3, 'students': 40}, {'name': 'BSAS 301-B',  'year': 3, 'students': 40},
    {'name': 'BSAS 301-C',  'year': 3, 'students': 40}, {'name': 'BSAS 301-D',  'year': 3, 'students': 40},
    {'name': 'BSAS 401-A',  'year': 4, 'students': 40}, {'name': 'BSAS 401-B',  'year': 4, 'students': 40},
    {'name': 'BSAS 401-C',  'year': 4, 'students': 40}, {'name': 'BSAS 401-D',  'year': 4, 'students': 40},
]
...
def seed_database():
    with app.app_context():
        ...
        print(f"  NOTE: This is the STRESS TEST seeder — larger than seed_db.py!")
        db.create_all()
        ...
        print(f"  ⚠ STRESS TEST: GA may run for 25-40 min before reaching HC=0")
