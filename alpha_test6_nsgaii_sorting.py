...
class GeneticSchedulerTC6:
    ...
    def fast_non_dominated_sort(self, population):
        ...
        domination_cnt = [0] * n
        dom = GeneticSchedulerTC6._constrained_dominates
    ...
    def run_algorithm(self, progress_callback=None):
        start_t0 = time.time()
        print("=== RUNNING ALPHA TEST CASE 6: NSGA-II SORTING & CROWDING DISTANCE ===")
        print("Telemetry: O(N^2) Front computation enabled for Soft Phases.")
        ...
        for generation in range(1, MAX_GENERATIONS + 1):
            ...
            if hard_phase:
                ...
                # Flatten population back based on fronts and crowding distance
                population = []
                for f in fronts:
...
if __name__ == '__main__':
    print("================================================================")
    print("🧪 ALPHA TESTING: TEST CASE 6 (NSGA-II MULTI-OBJECTIVE SORTING)")
    print("================================================================")
    ...
    with app.app_context():
        ...
        scheduler = GeneticSchedulerTC6(courses, sections, faculty, rooms, pre_assignments, {}, start_time=7, end_time=21, allowed_days=active_days)
